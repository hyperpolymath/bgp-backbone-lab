...
git clone <https://github.com/hyperpolymath/flatracoon.git> cd
flatracoon
...
toolbox create flatracoon-dev toolbox enter flatracoon-dev \# Install
...
flatracoon/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/flatracoon/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/flatracoon/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/flatracoon/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/flatracoon/labels/perimeter-3) — Community sandbox scope
