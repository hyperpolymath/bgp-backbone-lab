https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/bgp-backbone-lab[image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF
Best Practices]]
...
|ASN allocation |Private ASN numbers (64512-65534)
|docs/asn-allocation.adoc

|Prefix allocation |IPv4/IPv6 prefixes to announce
